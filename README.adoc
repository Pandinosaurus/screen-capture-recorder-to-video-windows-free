...
Development of this repo partially funded by:

= Recall.ai - API for desktop recording =

If you’re looking for a hosted desktop recording API, consider checking out
 https://www.recall.ai/product/desktop-recording-sdk?utm_source=github&utm_medium=sponsorship&utm_campaign=rdp-screen-capture-recorder-to-video-windows-free[Recall.ai], an API that records Zoom, Google Meet, Microsoft Teams, in-person meetings, and more.
